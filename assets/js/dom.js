...
function createBook(idBook, inputBookTitle, inputBookAuthor, inputBookYear, inputBookIsComplete) {
  ...
  cardContainer.classList.add("card-body", "border-start", "border-5", "border-info", "d-flex", "justify-content-between");
...
function createActionDelete(idBook) {
  ...
  actionDelete.addEventListener("click", function () {
    let confirmation = confirm("Apakah anda yakin ingin menghapus daftar buku ini?");
